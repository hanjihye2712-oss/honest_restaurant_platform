...
EXCELLENT_RESTAURANT_URL = os.getenv(
    'EXCELLENT_RESTAURANT_URL',
...
# ── JWT 보안 설정 ──────────────────────────────────────────────────────────────
SIMPLE_JWT = {
    # 토큰 유효기간 (DEBUG=True: 개발용 완화, DEBUG=False: 운영 기준)
    "ACCESS_TOKEN_LIFETIME" : timedelta(minutes=1440 if DEBUG else 15),
